...
class InputValidationState with _$InputValidationState {
  ...
  String? get showNameErrorMesg => showError ? entity.nameErrorMsg : null;
  String? get showEmailErrorMesg => showError ? entity.emailErrorMsg : null;
  ...
  String get description {
    ...
    return 'Please enter your name and email XD';
  }
}
